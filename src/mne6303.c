...
MNEMONIC MneHD6303[] = {
    ...
    { NULL, v_mnemonic, "aim", MF_PREMASK,   AF_BYTEADR|AF_BYTEADRX, { 0x71, 0x61 }},
    { NULL, v_mnemonic, "oim", MF_PREMASK,   AF_BYTEADR|AF_BYTEADRX, { 0x72, 0x62 }},
    { NULL, v_mnemonic, "eim", MF_PREMASK,   AF_BYTEADR|AF_BYTEADRX, { 0x75, 0x65 }},
    { NULL, v_mnemonic, "tim", MF_PREMASK,   AF_BYTEADR|AF_BYTEADRX, { 0x7B, 0x6B }},
